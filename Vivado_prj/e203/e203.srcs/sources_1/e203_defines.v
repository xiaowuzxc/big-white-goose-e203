...
//
  ...
  `define E203_DECINFO_ALU_WFI   `E203_DECINFO_ALU_WFI_MSB:`E203_DECINFO_ALU_WFI_LSB 
      `define E203_DECINFO_ALU_SH1ADD_LSB  (`E203_DECINFO_ALU_WFI_MSB+1)
      `define E203_DECINFO_ALU_SH1ADD_MSB  (`E203_DECINFO_ALU_SH1ADD_LSB+1-1)
  `define E203_DECINFO_ALU_SH1ADD   `E203_DECINFO_ALU_SH1ADD_MSB:`E203_DECINFO_ALU_SH1ADD_LSB /*rtl change SH1ADD*/
      `define E203_DECINFO_ALU_SH2ADD_LSB  (`E203_DECINFO_ALU_SH1ADD_MSB+1)
      `define E203_DECINFO_ALU_SH2ADD_MSB  (`E203_DECINFO_ALU_SH2ADD_LSB+1-1)
  `define E203_DECINFO_ALU_SH2ADD   `E203_DECINFO_ALU_SH2ADD_MSB:`E203_DECINFO_ALU_SH2ADD_LSB /*rtl change SH2ADD*/
      `define E203_DECINFO_ALU_SH3ADD_LSB  (`E203_DECINFO_ALU_SH2ADD_MSB+1)
      `define E203_DECINFO_ALU_SH3ADD_MSB  (`E203_DECINFO_ALU_SH3ADD_LSB+1-1)
  `define E203_DECINFO_ALU_SH3ADD   `E203_DECINFO_ALU_SH3ADD_MSB:`E203_DECINFO_ALU_SH3ADD_LSB /*rtl change SH3ADD*/
      `define E203_DECINFO_ALU_ANDN_LSB  (`E203_DECINFO_ALU_SH3ADD_MSB+1)
      `define E203_DECINFO_ALU_ANDN_MSB  (`E203_DECINFO_ALU_ANDN_LSB+1-1)
  `define E203_DECINFO_ALU_ANDN   `E203_DECINFO_ALU_ANDN_MSB:`E203_DECINFO_ALU_ANDN_LSB /*rtl change ANDN*/
      `define E203_DECINFO_ALU_ORN_LSB  (`E203_DECINFO_ALU_ANDN_MSB+1)
      `define E203_DECINFO_ALU_ORN_MSB  (`E203_DECINFO_ALU_ORN_LSB+1-1)
  `define E203_DECINFO_ALU_ORN   `E203_DECINFO_ALU_ORN_MSB:`E203_DECINFO_ALU_ORN_LSB /*rtl change ORN*/
      `define E203_DECINFO_ALU_XNOR_LSB  (`E203_DECINFO_ALU_ORN_MSB+1)
      `define E203_DECINFO_ALU_XNOR_MSB  (`E203_DECINFO_ALU_XNOR_LSB+1-1)
  `define E203_DECINFO_ALU_XNOR   `E203_DECINFO_ALU_XNOR_MSB:`E203_DECINFO_ALU_XNOR_LSB /*rtl change XNOR*/
      `define E203_DECINFO_ALU_CLZ_LSB  (`E203_DECINFO_ALU_XNOR_MSB+1)
      `define E203_DECINFO_ALU_CLZ_MSB  (`E203_DECINFO_ALU_CLZ_LSB+1-1)
  `define E203_DECINFO_ALU_CLZ   `E203_DECINFO_ALU_CLZ_MSB:`E203_DECINFO_ALU_CLZ_LSB /*rtl change CLZ*/
      `define E203_DECINFO_ALU_CTZ_LSB  (`E203_DECINFO_ALU_CLZ_MSB+1)
      `define E203_DECINFO_ALU_CTZ_MSB  (`E203_DECINFO_ALU_CTZ_LSB+1-1)
  `define E203_DECINFO_ALU_CTZ   `E203_DECINFO_ALU_CTZ_MSB:`E203_DECINFO_ALU_CTZ_LSB /*rtl change CTZ*/
      `define E203_DECINFO_ALU_CPOP_LSB  (`E203_DECINFO_ALU_CTZ_MSB+1)
      `define E203_DECINFO_ALU_CPOP_MSB  (`E203_DECINFO_ALU_CPOP_LSB+1-1)
  `define E203_DECINFO_ALU_CPOP   `E203_DECINFO_ALU_CPOP_MSB:`E203_DECINFO_ALU_CPOP_LSB /*rtl change CPOP*/
      `define E203_DECINFO_ALU_MAX_LSB  (`E203_DECINFO_ALU_CPOP_MSB+1)
      `define E203_DECINFO_ALU_MAX_MSB  (`E203_DECINFO_ALU_MAX_LSB+1-1)
  `define E203_DECINFO_ALU_MAX   `E203_DECINFO_ALU_MAX_MSB:`E203_DECINFO_ALU_MAX_LSB /*rtl change MAX*/
      `define E203_DECINFO_ALU_MAXU_LSB  (`E203_DECINFO_ALU_MAX_MSB+1)
      `define E203_DECINFO_ALU_MAXU_MSB  (`E203_DECINFO_ALU_MAXU_LSB+1-1)
  `define E203_DECINFO_ALU_MAXU   `E203_DECINFO_ALU_MAXU_MSB:`E203_DECINFO_ALU_MAXU_LSB /*rtl change MAXU*/
      `define E203_DECINFO_ALU_MIN_LSB  (`E203_DECINFO_ALU_MAXU_MSB+1)
      `define E203_DECINFO_ALU_MIN_MSB  (`E203_DECINFO_ALU_MIN_LSB+1-1)
  `define E203_DECINFO_ALU_MIN   `E203_DECINFO_ALU_MIN_MSB:`E203_DECINFO_ALU_MIN_LSB /*rtl change MIN*/
      `define E203_DECINFO_ALU_MINU_LSB  (`E203_DECINFO_ALU_MIN_MSB+1)
      `define E203_DECINFO_ALU_MINU_MSB  (`E203_DECINFO_ALU_MINU_LSB+1-1)
  `define E203_DECINFO_ALU_MINU   `E203_DECINFO_ALU_MINU_MSB:`E203_DECINFO_ALU_MINU_LSB /*rtl change MINU*/
      `define E203_DECINFO_ALU_SEXTB_LSB  (`E203_DECINFO_ALU_MINU_MSB+1)
      `define E203_DECINFO_ALU_SEXTB_MSB  (`E203_DECINFO_ALU_SEXTB_LSB+1-1)
  `define E203_DECINFO_ALU_SEXTB   `E203_DECINFO_ALU_SEXTB_MSB:`E203_DECINFO_ALU_SEXTB_LSB /*rtl change SEXTB*/
      `define E203_DECINFO_ALU_SEXTH_LSB  (`E203_DECINFO_ALU_SEXTB_MSB+1)
      `define E203_DECINFO_ALU_SEXTH_MSB  (`E203_DECINFO_ALU_SEXTH_LSB+1-1)
  `define E203_DECINFO_ALU_SEXTH   `E203_DECINFO_ALU_SEXTH_MSB:`E203_DECINFO_ALU_SEXTH_LSB /*rtl change SEXTH*/
      `define E203_DECINFO_ALU_ZEXTH_LSB  (`E203_DECINFO_ALU_SEXTH_MSB+1)
      `define E203_DECINFO_ALU_ZEXTH_MSB  (`E203_DECINFO_ALU_ZEXTH_LSB+1-1)
  `define E203_DECINFO_ALU_ZEXTH   `E203_DECINFO_ALU_ZEXTH_MSB:`E203_DECINFO_ALU_ZEXTH_LSB /*rtl change ZEXTH*/
      `define E203_DECINFO_ALU_ROL_LSB  (`E203_DECINFO_ALU_ZEXTH_MSB+1)
      `define E203_DECINFO_ALU_ROL_MSB  (`E203_DECINFO_ALU_ROL_LSB+1-1)
  `define E203_DECINFO_ALU_ROL   `E203_DECINFO_ALU_ROL_MSB:`E203_DECINFO_ALU_ROL_LSB /*rtl change ROL*/
      `define E203_DECINFO_ALU_ROR_LSB  (`E203_DECINFO_ALU_ROL_MSB+1)
      `define E203_DECINFO_ALU_ROR_MSB  (`E203_DECINFO_ALU_ROR_LSB+1-1)
  `define E203_DECINFO_ALU_ROR   `E203_DECINFO_ALU_ROR_MSB:`E203_DECINFO_ALU_ROR_LSB /*rtl change ROR*/
      `define E203_DECINFO_ALU_ORCB_LSB  (`E203_DECINFO_ALU_ROR_MSB+1)
      `define E203_DECINFO_ALU_ORCB_MSB  (`E203_DECINFO_ALU_ORCB_LSB+1-1)
  `define E203_DECINFO_ALU_ORCB   `E203_DECINFO_ALU_ORCB_MSB:`E203_DECINFO_ALU_ORCB_LSB /*rtl change ORCB*/
      `define E203_DECINFO_ALU_REV8_LSB  (`E203_DECINFO_ALU_ORCB_MSB+1)
      `define E203_DECINFO_ALU_REV8_MSB  (`E203_DECINFO_ALU_REV8_LSB+1-1)
  `define E203_DECINFO_ALU_REV8   `E203_DECINFO_ALU_REV8_MSB:`E203_DECINFO_ALU_REV8_LSB /*rtl change REV8*/
      `define E203_DECINFO_ALU_CLMUL_LSB  (`E203_DECINFO_ALU_REV8_MSB+1)
      `define E203_DECINFO_ALU_CLMUL_MSB  (`E203_DECINFO_ALU_CLMUL_LSB+1-1)
  `define E203_DECINFO_ALU_CLMUL   `E203_DECINFO_ALU_CLMUL_MSB:`E203_DECINFO_ALU_CLMUL_LSB /*rtl change CLMUL*/
      `define E203_DECINFO_ALU_CLMULH_LSB  (`E203_DECINFO_ALU_CLMUL_MSB+1)
      `define E203_DECINFO_ALU_CLMULH_MSB  (`E203_DECINFO_ALU_CLMULH_LSB+1-1)
  `define E203_DECINFO_ALU_CLMULH   `E203_DECINFO_ALU_CLMULH_MSB:`E203_DECINFO_ALU_CLMULH_LSB /*rtl change CLMULH*/
      `define E203_DECINFO_ALU_CLMULR_LSB  (`E203_DECINFO_ALU_CLMULH_MSB+1)
      `define E203_DECINFO_ALU_CLMULR_MSB  (`E203_DECINFO_ALU_CLMULR_LSB+1-1)
  `define E203_DECINFO_ALU_CLMULR   `E203_DECINFO_ALU_CLMULR_MSB:`E203_DECINFO_ALU_CLMULR_LSB /*rtl change CLMULR*/
      `define E203_DECINFO_ALU_BCLR_LSB  (`E203_DECINFO_ALU_CLMULR_MSB+1)
      `define E203_DECINFO_ALU_BCLR_MSB  (`E203_DECINFO_ALU_BCLR_LSB+1-1)
  `define E203_DECINFO_ALU_BCLR   `E203_DECINFO_ALU_BCLR_MSB:`E203_DECINFO_ALU_BCLR_LSB /*rtl change*/
      `define E203_DECINFO_ALU_BEXT_LSB  (`E203_DECINFO_ALU_BCLR_MSB+1)
      `define E203_DECINFO_ALU_BEXT_MSB  (`E203_DECINFO_ALU_BEXT_LSB+1-1)
  `define E203_DECINFO_ALU_BEXT   `E203_DECINFO_ALU_BEXT_MSB:`E203_DECINFO_ALU_BEXT_LSB /*rtl change*/
      `define E203_DECINFO_ALU_BINV_LSB  (`E203_DECINFO_ALU_BEXT_MSB+1)
      `define E203_DECINFO_ALU_BINV_MSB  (`E203_DECINFO_ALU_BINV_LSB+1-1)
  `define E203_DECINFO_ALU_BINV   `E203_DECINFO_ALU_BINV_MSB:`E203_DECINFO_ALU_BINV_LSB /*rtl change*/
      `define E203_DECINFO_ALU_BSET_LSB  (`E203_DECINFO_ALU_BINV_MSB+1)
      `define E203_DECINFO_ALU_BSET_MSB  (`E203_DECINFO_ALU_BSET_LSB+1-1)
  `define E203_DECINFO_ALU_BSET   `E203_DECINFO_ALU_BSET_MSB:`E203_DECINFO_ALU_BSET_LSB /*rtl change*/
      `define E203_DECINFO_ALU_MUL_LSB  (`E203_DECINFO_ALU_BSET_MSB+1)
      `define E203_DECINFO_ALU_MUL_MSB  (`E203_DECINFO_ALU_MUL_LSB+1-1)
  `define E203_DECINFO_ALU_MUL   `E203_DECINFO_ALU_MUL_MSB:`E203_DECINFO_ALU_MUL_LSB /*rtl change*/
      `define E203_DECINFO_ALU_MULH_LSB  (`E203_DECINFO_ALU_MUL_MSB+1)
      `define E203_DECINFO_ALU_MULH_MSB  (`E203_DECINFO_ALU_MULH_LSB+1-1)
  `define E203_DECINFO_ALU_MULH   `E203_DECINFO_ALU_MULH_MSB:`E203_DECINFO_ALU_MULH_LSB /*rtl change*/
      `define E203_DECINFO_ALU_MULHSU_LSB  (`E203_DECINFO_ALU_MULH_MSB+1)
      `define E203_DECINFO_ALU_MULHSU_MSB  (`E203_DECINFO_ALU_MULHSU_LSB+1-1)
  `define E203_DECINFO_ALU_MULHSU   `E203_DECINFO_ALU_MULHSU_MSB:`E203_DECINFO_ALU_MULHSU_LSB /*rtl change*/
      `define E203_DECINFO_ALU_MULHU_LSB  (`E203_DECINFO_ALU_MULHSU_MSB+1)
      `define E203_DECINFO_ALU_MULHU_MSB  (`E203_DECINFO_ALU_MULHU_LSB+1-1)
  `define E203_DECINFO_ALU_MULHU   `E203_DECINFO_ALU_MULHU_MSB:`E203_DECINFO_ALU_MULHU_LSB /*rtl change*/


  `define E203_DECINFO_ALU_WIDTH    (`E203_DECINFO_ALU_MULHU_MSB+1)/*rtl change*/
...
`define E203_DECINFO_NICE_WIDTH  (`E203_DECINFO_NICE_INSTR_MSB+1)//org=31
...
`define E203_DECINFO_WIDTH  (`E203_DECINFO_ALU_WIDTH+1)
