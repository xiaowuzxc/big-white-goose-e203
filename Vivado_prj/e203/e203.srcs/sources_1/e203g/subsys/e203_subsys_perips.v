...
wire [1:0]YD_OUT;
 ...
 assign  io_pads_gpioA_o_oe[20]     =  gpioA_iof[20]   ? 1'b1                           : gpioA_o_oe[20];//rtl change o
 assign  io_pads_gpioA_o_oe[21]     =  gpioA_iof[21]   ? 1'b1                           : gpioA_o_oe[21];//rtl change o
 assign  io_pads_gpioA_o_oe[22]     =  gpioA_iof[22]   ? 1'b1                           : gpioA_o_oe[22];//rtl change o
 assign  io_pads_gpioA_o_oe[23]     =  gpioA_iof[23]   ? 1'b1                           : gpioA_o_oe[23];//rtl change o
 assign  io_pads_gpioA_o_oe[24]     =  gpioA_iof[24]   ? 1'b0                           : gpioA_o_oe[24];//rtl change i
 assign  io_pads_gpioA_o_oe[25]     =  gpioA_iof[25]   ? 1'b0                           : gpioA_o_oe[25];//rtl change i
 ...
 assign  io_pads_gpioA_o_oval[20]   =  gpioA_iof[20]   ? YD_PWM_P                       : gpioA_o_oval[20];//rtl change
 assign  io_pads_gpioA_o_oval[21]   =  gpioA_iof[21]   ? YD_PWM_N                       : gpioA_o_oval[21];//rtl change
 assign  io_pads_gpioA_o_oval[22]   =  gpioA_iof[22]   ? YD_OUT[0]                      : gpioA_o_oval[22];//rtl change
 assign  io_pads_gpioA_o_oval[23]   =  gpioA_iof[23]   ? YD_OUT[1]                      : gpioA_o_oval[23];//rtl change
 ...
 assign  YD_IN[0]                   =  gpioA_in_sync[24];//rtl change
 assign  YD_IN[1]                   =  gpioA_in_sync[25];//rtl change
