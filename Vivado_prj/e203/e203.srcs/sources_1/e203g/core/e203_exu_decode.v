...
module e203_exu_decode(
  ...
  wire opcode_4_2_100 = (opcode[4:2] == 3'b100);//B ex all/*rtl change*/
  wire opcode_4_2_101 = (opcode[4:2] == 3'b101);
  wire opcode_4_2_110 = (opcode[4:2] == 3'b110);
  wire opcode_4_2_111 = (opcode[4:2] == 3'b111);
  wire opcode_6_5_00  = (opcode[6:5] == 2'b00);//I type
  wire opcode_6_5_01  = (opcode[6:5] == 2'b01);//R type
  wire opcode_6_5_10  = (opcode[6:5] == 2'b10);
  wire opcode_6_5_11  = (opcode[6:5] == 2'b11);

  wire rv32_func3_000 = (rv32_func3 == 3'b000);
  wire rv32_func3_001 = (rv32_func3 == 3'b001);//bset/i,binv/i,bclr/i
  wire rv32_func3_010 = (rv32_func3 == 3'b010);
  wire rv32_func3_011 = (rv32_func3 == 3'b011);
  wire rv32_func3_100 = (rv32_func3 == 3'b100);
  wire rv32_func3_101 = (rv32_func3 == 3'b101);//bext/i
  ...
  wire rv32_func7_0010100 = (rv32_func7 == 7'b0010100);//bset,bseti 
  ...
  /*rtl change*/
  wire rv32_func7_0100100 = (rv32_func7 == 7'b0100100);//bclr,bclri,bext,bexti
  wire rv32_func7_0110100 = (rv32_func7 == 7'b0110100);//binv,binvi
...
/*rtl change*/
  wire rv32_clz      = rv32_op_imm & rv32_func3_001 & rv32_func7_0110000 & (rv32_instr[24:20] == 5'b00000);
  wire rv32_ctz      = rv32_op_imm & rv32_func3_001 & rv32_func7_0110000 & (rv32_instr[24:20] == 5'b00001);
  wire rv32_cpop     = rv32_op_imm & rv32_func3_001 & rv32_func7_0110000 & (rv32_instr[24:20] == 5'b00010);
  wire rv32_sextb    = rv32_op_imm & rv32_func3_001 & rv32_func7_0110000 & (rv32_instr[24:20] == 5'b00100);
  wire rv32_sexth    = rv32_op_imm & rv32_func3_001 & rv32_func7_0110000 & (rv32_instr[24:20] == 5'b00101);
  wire rv32_rori     = rv32_op_imm & rv32_func3_101 & rv32_func7_0110000;
  wire rv32_orcb     = rv32_op_imm & rv32_func3_101 & rv32_func7_0010100 & (rv32_instr[24:20] == 5'b00111);
  wire rv32_rev8     = rv32_op_imm & rv32_func3_101 & rv32_func7_0110100 & (rv32_instr[24:20] == 5'b11000);
  wire rv32_bclri    = rv32_op_imm & rv32_func3_001 & rv32_func7_0100100;
  wire rv32_bexti    = rv32_op_imm & rv32_func3_101 & rv32_func7_0100100;
  wire rv32_binvi    = rv32_op_imm & rv32_func3_001 & rv32_func7_0110100;
  wire rv32_bseti    = rv32_op_imm & rv32_func3_001 & rv32_func7_0010100;
/*rtl change*/
...
/*rtl change*/
  wire rv32_sh1add   = rv32_op     & rv32_func3_010 & rv32_func7_0010000;
  wire rv32_sh2add   = rv32_op     & rv32_func3_100 & rv32_func7_0010000;
  wire rv32_sh3add   = rv32_op     & rv32_func3_110 & rv32_func7_0010000;
  wire rv32_andn     = rv32_op     & rv32_func3_111 & rv32_func7_0100000;
  wire rv32_orn      = rv32_op     & rv32_func3_110 & rv32_func7_0100000;
  wire rv32_xnor     = rv32_op     & rv32_func3_100 & rv32_func7_0100000;
  wire rv32_bmax     = rv32_op     & rv32_func3_110 & rv32_func7_0000101;
  wire rv32_bmaxu    = rv32_op     & rv32_func3_111 & rv32_func7_0000101;
  wire rv32_bmin     = rv32_op     & rv32_func3_100 & rv32_func7_0000101;
  wire rv32_bminu    = rv32_op     & rv32_func3_101 & rv32_func7_0000101;
  wire rv32_zexth    = rv32_op     & rv32_func3_100 & rv32_func7_0000100 & (rv32_instr[24:20] == 5'b00000);
  wire rv32_rol      = rv32_op     & rv32_func3_001 & rv32_func7_0110000;
  wire rv32_ror      = rv32_op     & rv32_func3_101 & rv32_func7_0110000;
  wire rv32_clmul    = rv32_op     & rv32_func3_001 & rv32_func7_0000101;
  wire rv32_clmulh   = rv32_op     & rv32_func3_011 & rv32_func7_0000101;
  wire rv32_clmulr   = rv32_op     & rv32_func3_010 & rv32_func7_0000101;
  wire rv32_bclr     = rv32_op     & rv32_func3_001 & rv32_func7_0100100;
  wire rv32_bext     = rv32_op     & rv32_func3_101 & rv32_func7_0100100;
  wire rv32_binv     = rv32_op     & rv32_func3_001 & rv32_func7_0110100;
  wire rv32_bset     = rv32_op     & rv32_func3_001 & rv32_func7_0010100;
  wire rv32_mul      = rv32_op     & rv32_func3_000 & rv32_func7_0000001;//mul
  wire rv32_mulh     = rv32_op     & rv32_func3_001 & rv32_func7_0000001;//mul
  wire rv32_mulhsu   = rv32_op     & rv32_func3_010 & rv32_func7_0000001;//mul
  wire rv32_mulhu    = rv32_op     & rv32_func3_011 & rv32_func7_0000001;//mul
/*rtl change*/
  ...
  wire alu_op = (~rv32_sxxi_shamt_ilgl) & (~rv16_sxxi_shamt_ilgl) 
              ...
              ( rv32_op_imm 
              | rv32_op & (~(rv32_func7_0000001 &( rv32_func3_100 | rv32_func3_101 | rv32_func3_110 | rv32_func3_111))) // Exclude the MULDIV
              | rv32_auipc
              | rv32_lui
              | rv16_addi4spn
              | rv16_addi         
...
/*rtl change*/
  assign alu_info_bus[`E203_DECINFO_ALU_SH1ADD]  = rv32_sh1add;
  assign alu_info_bus[`E203_DECINFO_ALU_SH2ADD]  = rv32_sh2add;
  assign alu_info_bus[`E203_DECINFO_ALU_SH3ADD]  = rv32_sh3add;
  assign alu_info_bus[`E203_DECINFO_ALU_ANDN  ]  = rv32_andn;
  assign alu_info_bus[`E203_DECINFO_ALU_ORN   ]  = rv32_orn;
  assign alu_info_bus[`E203_DECINFO_ALU_XNOR  ]  = rv32_xnor;
  assign alu_info_bus[`E203_DECINFO_ALU_CLZ   ]  = rv32_clz;
  assign alu_info_bus[`E203_DECINFO_ALU_CTZ   ]  = rv32_ctz;
  assign alu_info_bus[`E203_DECINFO_ALU_CPOP  ]  = rv32_cpop;
  assign alu_info_bus[`E203_DECINFO_ALU_MAX   ]  = rv32_bmax;
  assign alu_info_bus[`E203_DECINFO_ALU_MAXU  ]  = rv32_bmaxu;
  assign alu_info_bus[`E203_DECINFO_ALU_MIN   ]  = rv32_bmin;
  assign alu_info_bus[`E203_DECINFO_ALU_MINU  ]  = rv32_bminu;
  assign alu_info_bus[`E203_DECINFO_ALU_SEXTB ]  = rv32_sextb;
  assign alu_info_bus[`E203_DECINFO_ALU_SEXTH ]  = rv32_sexth;
  assign alu_info_bus[`E203_DECINFO_ALU_ZEXTH ]  = rv32_zexth;
  assign alu_info_bus[`E203_DECINFO_ALU_ROL   ]  = rv32_rol;
  assign alu_info_bus[`E203_DECINFO_ALU_ROR   ]  = rv32_ror | rv32_rori;
  assign alu_info_bus[`E203_DECINFO_ALU_ORCB  ]  = rv32_orcb;
  assign alu_info_bus[`E203_DECINFO_ALU_REV8  ]  = rv32_rev8;
  assign alu_info_bus[`E203_DECINFO_ALU_CLMUL ]  = rv32_clmul;
  assign alu_info_bus[`E203_DECINFO_ALU_CLMULH]  = rv32_clmulh;
  assign alu_info_bus[`E203_DECINFO_ALU_CLMULR]  = rv32_clmulr;
  assign alu_info_bus[`E203_DECINFO_ALU_BCLR  ]  = rv32_bclr | rv32_bclri;
  assign alu_info_bus[`E203_DECINFO_ALU_BEXT  ]  = rv32_bext | rv32_bexti;
  assign alu_info_bus[`E203_DECINFO_ALU_BINV  ]  = rv32_binv | rv32_binvi;
  assign alu_info_bus[`E203_DECINFO_ALU_BSET  ]  = rv32_bset | rv32_bseti;
  assign alu_info_bus[`E203_DECINFO_ALU_MUL   ]  = rv32_mul   ;
  assign alu_info_bus[`E203_DECINFO_ALU_MULH  ]  = rv32_mulh  ;
  assign alu_info_bus[`E203_DECINFO_ALU_MULHSU]  = rv32_mulhsu;
  assign alu_info_bus[`E203_DECINFO_ALU_MULHU ]  = rv32_mulhu ;
/*rtl change*/
  ...
  wire muldiv_op = rv32_op & rv32_func7_0000001 & (rv32_func3_100 | rv32_func3_101 | rv32_func3_110 | rv32_func3_111);//rtl change mul
  `endif//}
  ...
  assign muldiv_info_bus[`E203_DECINFO_MULDIV_MUL   ] = 0    ;//rtl change mul
  assign muldiv_info_bus[`E203_DECINFO_MULDIV_MULH  ] = 0   ;//rtl change mul
  assign muldiv_info_bus[`E203_DECINFO_MULDIV_MULHSU] = 0 ;//rtl change mul
  assign muldiv_info_bus[`E203_DECINFO_MULDIV_MULHU ] = 0  ;//rtl change mul
  ...
  assign dec_mulhsu = 0;//rtl change mul
  assign dec_mul    = 0;//rtl change mul
  ...
  wire rv32_need_rs2 = (~rv32_rs2_x0) & (
                ...
                (
                 (rv32_branch)
               | (rv32_sh1add)/*rtl change*/
               | (rv32_sh2add)/*rtl change*/
               | (rv32_sh3add)/*rtl change*/
               | (rv32_andn)/*rtl change*/
               | (rv32_orn)/*rtl change*/
               | (rv32_xnor)/*rtl change*/
               | (rv32_bmax)/*rtl change*/
               | (rv32_bmaxu)/*rtl change*/
               | (rv32_bmin)/*rtl change*/
               | (rv32_bminu)/*rtl change*/
               | (rv32_rol)/*rtl change*/
               | (rv32_ror)/*rtl change*/
               | (rv32_clmul)/*rtl change*/
               | (rv32_clmulh)/*rtl change*/
               | (rv32_clmulr)/*rtl change*/
               | (rv32_bclr)/*rtl change*/
               | (rv32_bext)/*rtl change*/
               | (rv32_binv)/*rtl change*/
               | (rv32_bset)/*rtl change*/
               | (rv32_mul   )/*rtl change*/
               | (rv32_mulh  )/*rtl change*/
               | (rv32_mulhsu)/*rtl change*/
               | (rv32_mulhu )/*rtl change*/
               | (rv32_store)
               | (rv32_op)
               | (rv32_amo & (~rv32_lr_w))
                 )
