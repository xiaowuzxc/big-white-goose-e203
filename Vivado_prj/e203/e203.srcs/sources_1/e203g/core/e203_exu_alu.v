...
`endif//}
  ...
  /*rtl change*/
  wire alu_req_alu_sh1add ;
  wire alu_req_alu_sh2add ;
  wire alu_req_alu_sh3add ;
  wire alu_req_alu_andn ;
  wire alu_req_alu_orn ;
  wire alu_req_alu_xnor ;
  wire alu_req_alu_clz ;
  wire alu_req_alu_ctz ;
  wire alu_req_alu_cpop ;
  wire alu_req_alu_bmax ;
  wire alu_req_alu_bmaxu ;
  wire alu_req_alu_bmin ;
  wire alu_req_alu_bminu ;
  wire alu_req_alu_sextb ;
  wire alu_req_alu_sexth ;
  wire alu_req_alu_zexth ;
  wire alu_req_alu_rol ;
  wire alu_req_alu_ror ;
  wire alu_req_alu_orcb ;
  wire alu_req_alu_rev8 ;
  wire alu_req_alu_clmul ;
  wire alu_req_alu_clmulh ;
  wire alu_req_alu_clmulr ;
  wire alu_req_alu_bclr ;
  wire alu_req_alu_bext ;
  wire alu_req_alu_binv ;
  wire alu_req_alu_bset ;
  wire alu_req_alu_mul   ;
  wire alu_req_alu_mulh  ;
  wire alu_req_alu_mulhsu;
  wire alu_req_alu_mulhu ;
  /*rtl change*/
  ...
  e203_exu_alu_rglr u_e203_exu_alu_rglr(
      ...
      /*rtl change*/
      .alu_req_alu_sh1add  (alu_req_alu_sh1add     ),
      .alu_req_alu_sh2add  (alu_req_alu_sh2add     ),
      .alu_req_alu_sh3add  (alu_req_alu_sh3add     ),
      .alu_req_alu_andn    (alu_req_alu_andn       ),
      .alu_req_alu_orn     (alu_req_alu_orn        ),
      .alu_req_alu_xnor    (alu_req_alu_xnor       ),
      .alu_req_alu_clz     (alu_req_alu_clz        ),
      .alu_req_alu_ctz     (alu_req_alu_ctz        ),
      .alu_req_alu_cpop    (alu_req_alu_cpop       ),
      .alu_req_alu_bmax    (alu_req_alu_bmax       ),
      .alu_req_alu_bmaxu   (alu_req_alu_bmaxu      ),
      .alu_req_alu_bmin    (alu_req_alu_bmin       ),
      .alu_req_alu_bminu   (alu_req_alu_bminu      ),
      .alu_req_alu_sextb   (alu_req_alu_sextb      ),
      .alu_req_alu_sexth   (alu_req_alu_sexth      ),
      .alu_req_alu_zexth   (alu_req_alu_zexth      ),
      .alu_req_alu_rol     (alu_req_alu_rol        ),
      .alu_req_alu_ror     (alu_req_alu_ror        ),
      .alu_req_alu_orcb    (alu_req_alu_orcb       ),
      .alu_req_alu_rev8    (alu_req_alu_rev8       ),
      .alu_req_alu_clmul   (alu_req_alu_clmul      ),
      .alu_req_alu_clmulh  (alu_req_alu_clmulh     ),
      .alu_req_alu_clmulr  (alu_req_alu_clmulr     ),
      .alu_req_alu_bclr    (alu_req_alu_bclr       ),
      .alu_req_alu_bext    (alu_req_alu_bext       ),
      .alu_req_alu_binv    (alu_req_alu_binv       ),
      .alu_req_alu_bset    (alu_req_alu_bset       ),
      .alu_req_alu_mul     (alu_req_alu_mul        ),
      .alu_req_alu_mulh    (alu_req_alu_mulh       ),
      .alu_req_alu_mulhsu  (alu_req_alu_mulhsu     ),
      .alu_req_alu_mulhu   (alu_req_alu_mulhu      ),
      /*rtl change*/
